...
--
-- Table structure for table `dados_user`
--
...
--
-- Dumping data for table `dados_user`
--

LOCK TABLES `dados_user` WRITE;
/*!40000 ALTER TABLE `dados_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `dados_user` ENABLE KEYS */;
UNLOCK TABLES;
